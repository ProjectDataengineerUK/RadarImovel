...
class BanestesNormalizer:
    ...
    def normalize(self, raw: RawProperty) -> dict:
        ...
        try:
            ...
            state = (clean_text(d.get("state")) or "ES").upper()[:2]
            ...
            return {
                ...
                "edital_number": clean_text(d.get("edital_number"), max_len=50),
            ...
            logger.error(
                "banestes.normalizer.failed", external_code=raw.external_code, error=str(exc)
            )
            raise

"""Normalizer Lance Certo → schema Property."""
...
class LanceCertoNormalizer:
    ...
    def normalize(self, raw: RawProperty) -> dict:
        ...
        try:
            ...
            logger.error("lance_certo.normalize_error", external_code=raw.external_code, error=str(exc))
            raise

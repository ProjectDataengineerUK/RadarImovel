...
class Property(Base):
    ...
    source_type: Mapped[str] = mapped_column(String(20), default="bank", nullable=False)
    auction_stage: Mapped[str | None] = mapped_column(String(30))
    process_number: Mapped[str | None] = mapped_column(String(50))
    market_price_per_sqm: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
    discount_vs_market_pct: Mapped[Decimal | None] = mapped_column(Numeric(5, 2))
